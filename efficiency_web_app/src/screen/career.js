    ...
    <div className='mainCarr'>
      <div className="department-page">
        <div className="left-column" id="mission">
          ...
          <div class="slpd-overview" id='mission'>
      ...
      <div className='opportunity' >
        ...
        <ul>
          ...
          <li>
            <strong>Forensic Scientist:</strong> Analyzes evidence collected from crime scenes using scientific techniques, such as DNA analysis,
            ballistics, and toxicology, to provide evidence for criminal investigations.
          </li>
          <li>
